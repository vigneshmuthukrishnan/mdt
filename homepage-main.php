...
<main class="premium-home">
    <div class="sticky top-20 z-40 overflow-hidden bg-gradient-to-r from-blue-700 via-indigo-700 to-blue-700 px-4 py-2.5 text-center text-sm font-semibold text-white shadow-md sm:text-base">
        ...
        <span class="relative inline-flex flex-wrap items-center justify-center gap-2">
            ...
            <a href="index.php#book-free-demo" class="font-black text-cyan-200 underline decoration-cyan-300/70 underline-offset-4 transition hover:text-white">Claim Now &rarr;</a>
        </span>
    </div>
        ...
        <div class="relative z-10 mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
            <div>
                ...
                <div class="mt-8 flex flex-wrap gap-4">
                    <a href="index.php#book-free-demo" class="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-6 py-4 font-bold text-white shadow-lg shadow-blue-600/25 transition hover:-translate-y-1 hover:bg-blue-700"><?= $homeIcon('rocket', 'h-5 w-5') ?> Start Free Trial</a>
    ...
    <section id="book-free-demo" class="relative scroll-mt-32 overflow-hidden bg-gradient-to-br from-blue-700 to-indigo-900 py-14 lg:py-16 text-white">
        <span id="contact" class="absolute -top-32"></span>
