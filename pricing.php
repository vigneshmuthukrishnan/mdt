        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-5xl mx-auto" data-aos="fade-up">
                ...
                <div class="flex flex-wrap gap-6 justify-center">
                    <a href="index.php#book-free-demo" target="_blank" class="group relative px-10 py-5 bg-blue-600 text-white rounded-2xl font-black text-lg overflow-hidden transition-all hover:bg-blue-500 hover:scale-105 active:scale-95 shadow-[0_20px_40px_-10px_rgba(59,130,246,0.5)]">
                    ...
                    <a href="index.php#book-free-demo" target="_blank" class="px-10 py-5 bg-white/5 hover:bg-white/10 text-white border border-white/10 rounded-2xl font-black text-lg backdrop-blur-md transition-all hover:scale-105">
                        Get Started
                    </a>
                </div>
            </div>
